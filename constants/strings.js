...
export const STRINGS = {
  ...
  errors: {
    ...
    server: 'Server error. Please try again later. If the problem persists, contact support.',
    ...
    firebase: {
      emailExists: 'Email already exists. Please use a different email or log in.',
      operationNotAllowed: 'This operation is not allowed. Please try again later.',
      tooManyAttempts: 'Too many failed login attempts. Please try again in a few minutes.',
      ...
      weakPassword: 'Password is too weak. Please use at least 6 characters including letters and numbers.',
    },
  },
